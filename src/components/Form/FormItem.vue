<template>
  <div
    ...
    :class="{
      ...
      'is-success': validateStatus.state === 'error',
      'is-loading': validateStatus.loading,
      'is-required': isRequired,
    }"
  >
    <label class="ev-form-item__label">
      <slot name="label" :label="label">{{ label }}</slot>
    </label>
    <div class="ev-form-item__content">
      <slot :validate="validate" />
      <div class="ev-form-item__error-msg" v-if="validateStatus.state === 'error'">
...
const innerValue = computed(() => {
  ...
  if (model && props.prop && (isString(model[props.prop]) || isNumber(model[props.prop]))) {
